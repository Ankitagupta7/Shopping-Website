<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterAdmin.master" AutoEventWireup="true" CodeFile="editDesign.aspx.cs" Inherits="admin_editDesign" %>
                        ...
                        <div class="flot-chart">
                            ...
                            <div class="form-group">        
                              <div class="col-sm-offset-3 col-sm-9">
                                <asp:Button ID="updateProduct" runat="server" Text="Update Product" CssClass="btn btn-primary" OnClick="updateProduct_Click"  />
                              </div>
                            </div>
